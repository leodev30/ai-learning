...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        #Tim vi tri co xac suat xay ra cao nhat cua cac con ma va tinh khoang cach
        mostOcurGhostPositions = []
        for index in range(len(livingGhostPositionDistributions)):
            ...
            for position, prob in livingGhostPositionDistributions[index].items():
                if prob > highestProb:
                    highestProb = prob
                    mostProbPosition = position

            mostOcurGhostPositions.append((mostProbPosition, self.distancer.getDistance(mostProbPosition, pacmanPosition)))
        #Tim vi tri cua con ma gan nhat va tinh khoang cach
        minDistance = float('inf')
        closestPosition = None
        for ghostPosition, distance in mostOcurGhostPositions:
            if distance < minDistance:
                minDistance = distance
                closestPosition = ghostPosition
        #Dua ra hanh dong tot nhat
