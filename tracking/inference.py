...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        #Truong hop jail edge gan lai allPossible = 1.0
        else:  
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for oldPos in self.legalPositions:
            # print(self.setGhostPosition(gameState, oldPos))
            positionDist = self.getPositionDistribution(self.setGhostPosition(gameState, oldPos))
            # print(positionDist)
            for newPos, XacSuat in positionDist.items():
                newBeliefs[newPos] += XacSuat * self.beliefs[oldPos]
